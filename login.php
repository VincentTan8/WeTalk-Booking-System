        ...
        <div class="login-form-container p-4">
            ...
            <form action="" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="email_or_username" class="form-control" placeholder="Enter your email or username" required>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a href="https://wetalk.com/booking/forgot" class="text-muted forgot-password-link">Forgot Password?</a>
                </div>
            ...
            <div class="text-center mt-3">
                <span>Don't have an account? <br> <a href="signupnow.php" class="fw-bold text-dark" id="signUpText">Sign Up</a></span>
            </div>
        </div>
    </div>
</div>
