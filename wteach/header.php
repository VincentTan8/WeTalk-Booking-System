...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
        ...
        <!-- Navigation Bar -->
        <nav class="navbar navbar-expand-lg navbar-light" style=" box-shadow: 0px 0px 14.4px rgba(3, 1, 30, 0.15); border-radius: 15px;background:white; margin-top:50px; padding-top: 20px; padding-left:50px; padding-right:50px; padding-bottom:20px;">
                ...
                <div class="collapse navbar-collapse" id="navbarContent" style="justify-content: space-between; height:60px;">
                    <div class="d-flex align-items-center">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-family: Poppins; gap:50px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo $current == 'student' ? 'active fw-bold text-primary' : ''; ?>" href="student.php">My Student</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo $current == 'class' ? 'active fw-bold text-primary' : ''; ?>" href="calendar.php">My Schedule</a>
                            </li>
                            <!-- <li class="nav-item">
